    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        try {
            ...
            if ($e->errorInfo[1] == 1062) {
                ...
                $error = "Erro ao tentar registrar: " . $e->getMessage();
            }
        }
    }
?>
    ...
    <div class="container">
        <div class="menu">
            <form action="cadastro_proprietario.php" method="POST" class="form">
                ...
                <input type="submit" name="cadastro" value="Cadastrar" class="submit">
                <u>Já possui uma conta? <a href="../index.php">Logar</a></u>
                <p class="erro"></p>
            </form>
        </div>
    </div>
